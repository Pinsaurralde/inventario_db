...
<div class="form-section">
    <form action="entrada_insumo.php?id=<?php echo htmlspecialchars($insumo_id); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <textarea id="comentario" name="comentario" placeholder="Ej: Compra a proveedor X, Devolución de cliente, etc." rows="4"><?php echo htmlspecialchars($comentario); ?></textarea>
        </div>
