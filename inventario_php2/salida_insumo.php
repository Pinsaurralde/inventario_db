...
<div class="form-section">
    <form action="salida_insumo.php?id=<?php echo htmlspecialchars($insumo_id); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <textarea id="comentario" name="comentario" placeholder="Ej: Venta al cliente Y, Uso interno, Merma, etc." rows="4" required><?php echo htmlspecialchars($comentario); ?></textarea>
        </div>
        <div class="form-group">
